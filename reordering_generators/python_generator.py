"""
Reordering generator for Python source code.
...
class PythonGenerator(Python3Listener):
    """
    ...
    SMALL_REORDERED_TYPES = [
        ...
        Python3Parser.ArglistContext,  # Arguments in function call
        Python3Parser.Arith_exprContext,  # +, -
        Python3Parser.TermContext,  # *, /, %
    ]

    LARGE_REORDERED_TYPES = [
        Python3Parser.File_inputContext,  # Top level of file
        Python3Parser.SuiteContext,  # Code blocks like a class or a function
    ]
    ...
    def __init__(self, tree, file_name):
        ...
        self.sorted_trees = {}
        self.sub_tree_sizes = []
        self.out_file = '/home/philo/Documents/uva/Jaar_3/thesis/CRDS/synthetic_data/reordered_substatement_tmp/Python3/ProgTalen/' + file_name.split('/')[-1]
    ...
    def exit_rule(self, ctx):
        ...
        elif type(ctx) in self.LARGE_REORDERED_TYPES:
            self.shuffle_children(ctx)
