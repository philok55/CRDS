...
class PythonGenerator(Python3Listener):
    ...
    def __init__(self, tree, file_name):
        ...
        self.sorted_trees = {}
        self.sub_tree_sizes = []
        self.results_folder = '/home/philo/Documents/uva/Jaar_3/thesis/CRDS/regenerated'
        file_name_s = file_name.split('.')
        file_name_s[-2] = file_name_s[-2] + '(att)'
        self.out_file = '.'.join(file_name_s)
    ...
    def exit_rule(self, ctx):
        ...
        """
        if type(ctx) in self.LARGE_REORDERED_TYPES:
