...
returntask1a(diameter[1],diameter[2],G)
...
deffind_shortest_paths(lengths,G):
    """
...
fornode1inG.nodes:
        fornode2inG.nodes:
            if(node1==node2or(node1,node2)incheckedor(node2,node1)incheckedorG.has_edge(node2,node1)):
                continue
